...
public class AlipayUtil {
     ...
     * @return
     */
    public static AlipayF2FPrecreateResult test_trade_precreate(String subject,String outTradeNo, String rechargeMoney, Integer customerId, String customerName, String customerPhone, String shopName, String callbackUrl) {
        ...
        AlipayTradePrecreateRequestBuilder builder = new AlipayTradePrecreateRequestBuilder()
                ...
                .setSubject("家有官家--扫码充值")
                .setBody(customerId + "-" + customerName + "-" + customerPhone + "-" + shopName + "-");
